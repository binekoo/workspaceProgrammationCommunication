...
package fr.upec.episen.generated;
...
public class Message {
    ...
    public boolean equals(Object other) {
        ...
        return (((((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties)))&&((this.creation == rhs.creation)||((this.creation!= null)&&this.creation.equals(rhs.creation))))&&((this.info == rhs.info)||((this.info!= null)&&this.info.equals(rhs.info))))&&((this.order == rhs.order)||((this.order!= null)&&this.order.equals(rhs.order))));
    }
